...
const scrollToAttendanceList = () => {
  if (typeof document === 'undefined') return;
  document.getElementById('attendance-list-card')?.scrollIntoView({ behavior: 'smooth', block: 'start' });
};
            ...
            <article className="card">
              <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <button
                    type="button"
                    onClick={() => openInNewTab(`/courses/salon/${selectedAttendanceAssignment.assignment_id}`)}
              ...
              <div className="mt-3 grid gap-2 text-sm text-primary-700 md:grid-cols-2 xl:grid-cols-3">
                ...
                <p>
                  <strong className="text-primary-900">Modalidad:</strong>{' '}
                  {selectedAttendanceAssignment.modality || 'PRESENCIAL'}
                </p>
                <p>
                  <strong className="text-primary-900">Salon/Horario:</strong>{' '}
                  {selectedAttendanceAssignment.classroom_info || 'Sin detalle registrado'}
                </p>
                <p>
                  <strong className="text-primary-900">Alumnos activos:</strong>{' '}
                  {selectedAttendanceAssignment.active_students}
                </p>
                <p>
                  <strong className="text-primary-900">Inicio:</strong>{' '}
                  {formatDate(selectedAttendanceAssignment.start_date)}
                </p>
                <p>
                  <strong className="text-primary-900">Fin:</strong>{' '}
                  {formatDate(selectedAttendanceAssignment.end_date)}
                </p>
              </div>
            </article>
          ) : null}
